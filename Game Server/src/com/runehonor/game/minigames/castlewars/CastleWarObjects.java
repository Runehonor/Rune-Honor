...
public class CastleWarObjects {
	...
	public static boolean handleObject(final Client c, final int id, final int x, final int y) {
		...
		case 4417:
            if (x == 2428 && y == 3081 && c.heightLevel == 1) {
                c.getAssistant().movePlayer(2430, 3080, 2);
            }
            if (x == 2425 && y == 3074 && c.heightLevel == 2) {
                c.getAssistant().movePlayer(2426, 3074, 3);
            }
            if (x == 2419 && y == 3078 && c.heightLevel == 0) {
                c.getAssistant().movePlayer(2420, 3080, 1);
            }
            break;
        case 4415:
            if (x == 2419 && y == 3080 && c.heightLevel == 1) {
                c.getAssistant().movePlayer(2419, 3077, 0);
            }
            if (x == 2430 && y == 3081 && c.heightLevel == 2) {
                c.getAssistant().movePlayer(2427, 3081, 1);
            }
            if (x == 2425 && y == 3074 && c.heightLevel == 3) {
                c.getAssistant().movePlayer(2425, 3077, 2);
            }
            if (x == 2374 && y == 3133 && c.heightLevel == 3) {
                c.getAssistant().movePlayer(2374, 3130, 2);
            }
            if (x == 2369 && y == 3126 && c.heightLevel == 2) {
                c.getAssistant().movePlayer(2372, 3126, 1);
            }
            if (x == 2380 && y == 3127 && c.heightLevel == 1) {
                c.getAssistant().movePlayer(2380, 3130, 0);
            }
            break;
        case 4419:
            if (x == 2417 && y == 3074) {
                if (c.absX == 2417 && c.absY == 3077) {
                	c.getAssistant().movePlayer(2416, 3074, 0);
                } else {
                	c.getAssistant().movePlayer(2417, 3077, 0);
                }
            }
            break;
        case 1747:
            if (x == 2421 && y == 3073 && c.heightLevel == 0) {
                c.getAssistant().movePlayer(2421, 3074, 1);
            }
            if (x == 2378 && y == 3134 && c.heightLevel == 0) {
                c.getAssistant().movePlayer(2378, 3133, 1);
            }
            break;

        case 4418:
            if (x == 2380 && y == 3127 && c.heightLevel == 0) {
                c.getAssistant().movePlayer(2379, 3127, 1);
            }
            if (x == 2369 && y == 3126 && c.heightLevel == 1) {
                c.getAssistant().movePlayer(2369, 3127, 2);
            }
            if (x == 2374 && y == 3131 && c.heightLevel == 2) {
                c.getAssistant().movePlayer(2373, 3133, 3);
            }
            break;
        case 4420:
            if (x == 2382 && y == 3131 && c.heightLevel == 0) {
                if (c.getX() >= 2383 && c.getX() <= 2385) {
                    c.getAssistant().movePlayer(2382, 3130, 0);
                } else {
                    c.getAssistant().movePlayer(2383, 3133, 0);
                }
            }
            break;
			case 4431 :
			...
			case 4411 : // Stepping stones + 1 ladder
				if (x == 2377 && y == 3088) {
					...
					c.getAssistant().movePlayer(c.getX(), c.getY(), 0);
				}
				return true;
			...
			case 1757 :
				if (x == 2400 && y == 9508) {
					c.getAssistant().climbLadder(true, 2400, 3107, 0);
				}
				if (x == 2399 && y == 9499) {
					c.getAssistant().climbLadder(true, 2399, 3100, 0);
				}
				if (x == 2430 && y == 9482) {
					c.getAssistant().climbLadder(true, 2430, 3081, 0);
				}
				if (x == 2369 && y == 9525) {
					c.getAssistant().climbLadder(true, 2369, 3126, 0);
				}
				return true;

			case 1568 :
				if (x == 2400 && y == 3108) {
					c.getAssistant().climbLadder(false, 2400, 9507, 0);
				}
				if (x == 2399 && y == 3099) {
					c.getAssistant().climbLadder(false, 2399, 9500, 0);
				}
				return true;
			...
			case 6280 :
				...
				c.getAssistant().climbLadder(true, 2429, 3075, 2);
				return true;
			...
			case 4471 :
				...
				c.getAssistant().climbLadder(false, 2429, 3075, 1);
				return true;
			...
			case 6281 :
				...
				c.getAssistant().climbLadder(true, 2370, 3132, 2);
				return true;
			...
			case 4472 :
				...
				c.getAssistant().climbLadder(false, 2370, 3132, 1);
				return true;
			...
			case 4469 :
				...
				if (x == 2426) {
					if (c.getY() == 3080) {
						c.getAssistant().movePlayer(2426, 3081, c.heightLevel);
					} else if (c.getY() == 3081) {
						c.getAssistant().movePlayer(2426, 3080, c.heightLevel);
					}
				} else if (x == 2422) {
					if (c.getX() == 2422) {
						c.getAssistant().movePlayer(2423, 3076, c.heightLevel);
					} else if (c.getX() == 2423) {
						c.getAssistant().movePlayer(2422, 3076, c.heightLevel);
					}
				}
				return true;
			...
			case 4470 :
				...
				if (x == 2373 && y == 3126) {
					if (c.getY() == 3126) {
						c.getAssistant().movePlayer(2373, 3127, 1);
					} else if (c.getY() == 3127) {
						c.getAssistant().movePlayer(2373, 3126, 1);
					}
				} else if (x == 2377 && y == 3131) {
					if (c.getX() == 2376) {
						c.getAssistant().movePlayer(2377, 3131, 1);
					} else if (c.getX() == 2377) {
						c.getAssistant().movePlayer(2376, 3131, 1);
					}
				}
				return true;
			...
			case 4911 :
				if (x == 2421 && y == 3073 && c.heightLevel == 1) {
					c.getAssistant().climbLadder(false, 2421, 3074, 0);
				}
				if (x == 2378 && y == 3134 && c.heightLevel == 1) {
					c.getAssistant().climbLadder(false, 2378, 3133, 0);
				}
				return true;

			case 4912 :
				if (x == 2430 && y == 3082 && c.heightLevel == 0) {
					c.getAssistant().climbLadder(false, 2430, 9481, 0);
				}
				if (x == 2369 && y == 3125 && c.heightLevel == 0) {
					c.getAssistant().climbLadder(false, 2369, 9526, 0);
				}
				return true;
			...
			case 4381 :
				...
				c.getAssistant().createPlayersStillGfx(287, sDamageArea[p][0], sDamageArea[p][1], 0, 1);
				c.getAssistant().hitPlayers(sDamageArea[p][0] - 2, sDamageArea[p][0] + 2, sDamageArea[p][1] - 2, sDamageArea[p][1] + 2, 2);
			...
			case 4382 :
				...
				c.getAssistant().hitPlayers(2379, 2393, 3104, 3118, 2);
				c.getItems().deleteItem(4043, 1);
				c.sendMessage("You fire the catapult!");
