package com.runehonor.game.npcs.pet;
...
public class PetData 
{
    ...
    public static int[][] petData = {
    	    ...
    	    {
	    	        4000, 14004 // King Black Dragon.
            },
		    {
		    	    4005, 14000 // Kree arra.
	        },
		    {
	        	    4001, 14001 // General Graardor.
	        },
		    {
        	        4006, 14002 // K'ril Tsutsaroth.
	        },
		    {
	        	    4007, 14003 // Commander Zilyana.
	        },	        
    		{
    				4003, 14007 // Chaos elemental.
    		},
    		{ 
    				4017, 14010 // Pet kraken
    		},
            {
                    761, 1555 // Pet kitten.
            },
