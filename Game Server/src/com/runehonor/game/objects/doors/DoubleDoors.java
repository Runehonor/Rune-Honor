package com.runehonor.game.objects.doors;
...
public class DoubleDoors {
	...
	public void load() {
		...
		System.out.println("[" + Constants.SERVER_NAME + "] " + doors.size() +" double doors have been loaded in "+ (System.currentTimeMillis() - start) +"ms...");
	}
