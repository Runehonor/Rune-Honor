...
public class SkillInterfaces {
    ...
    private void optionTab(String title, String currentTab, String op1,
		...
		c.getAssistant().sendFrame126(title, 8716);
		c.getAssistant().sendFrame126(currentTab, 8849);
        c.getAssistant().sendFrame126(op1, 8846);
        c.getAssistant().sendFrame126(op2, 8823);
        c.getAssistant().sendFrame126(op3, 8824);
        c.getAssistant().sendFrame126(op4, 8827);
        c.getAssistant().sendFrame126(op5, 8837);
        c.getAssistant().sendFrame126(op6, 8840);
        c.getAssistant().sendFrame126(op7, 8843);
        c.getAssistant().sendFrame126(op8, 8859);
        c.getAssistant().sendFrame126(op9, 8862);
        c.getAssistant().sendFrame126(op10, 8865);
        c.getAssistant().sendFrame126(op11, 15303);
        c.getAssistant().sendFrame126(op12, 15306);
        c.getAssistant().sendFrame126(op13, 15309);
		c.getAssistant().showInterface(8714);
	}
	...
	private void menuLine(final String levels, final String lines,
		...
		c.getAssistant().sendFrame126(lines, 8760 + lineCounter);
		c.getAssistant().sendFrame126(levels, 8720 + lineCounter);
