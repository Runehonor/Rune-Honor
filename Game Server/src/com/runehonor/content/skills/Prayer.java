                        ...
                        for (final Bones b : Bones.values()) {
                                if (ID == b.getID()) {
                                        ...
                                        if (doubleExperience >= 1) {
                                                ...
                                                c.getAssistant().addSkillXP(b.getXP() * Constants.PRAYER_EXPERIENCE, 5);
                                                ...
                                                c.getAssistant().addSkillXP(b.getXP() * 2 * Constants.PRAYER_EXPERIENCE, 5);
                ...
                for (final Bones b : Bones.values()) {
                        if (ID == b.getID()) {
                                if (Failure >= 1) {
                                        ...
                                        c.getAssistant().addSkillXP(b.getXP() * 4 * Constants.PRAYER_EXPERIENCE, 5);
