...
public void run() {
	...
	private static String osEnvironment = System.getProperty("os.name");

	public static String fetchLoadDirectory = (osEnvironment.startsWith("Windows") ? 
										  		System.getenv("APPDATA") : 
										  		System.getProperty("user.home")) + "/.RuneHonor474/";

    public static String findcachedir()
    {
        boolean exists = (new File(fetchLoadDirectory).exists());
        if (exists) {
            return fetchLoadDirectory;
        } else {
            File f = new File(fetchLoadDirectory);
            f.mkdir();
            return fetchLoadDirectory;
        }
    }
