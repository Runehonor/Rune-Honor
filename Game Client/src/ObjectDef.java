...
public final class ObjectDef {
	...
	public static ObjectDef forID(int i) {
		...
		if(i > 0 && dumpObjects) {
			try {
		    File file = new File ("C:/Users/objects/"+i+".txt");
		    try {
		        file.createNewFile();
		   }
		   catch (IOException e) {
		...
		if (i == 1501) { 
			class46.name = "Poll booth"; 
			class46.description = "Cast your votes here.".getBytes();
			class46.anInt744 = 1;
			class46.anInt761 = 1;
			class46.anIntArray773 = new int[1];
			class46.anIntArray773[0] = 45000;
			class46.actions = new String[5];
			class46.actions[0] = "Use";
			class46.hasActions = true;
			class46.aBoolean767 = false;
			class46.aBoolean762 = false;
			class46.aBoolean769 = false;
			class46.anInt740 = 90; // object length
			class46.anInt748 = 80; // object width
	        class46.anInt772 = 75; // object height
		}
		if (i == 11214) {
