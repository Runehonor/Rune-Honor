...
public final class Player extends Entity {
	...
	public Model getRotatedModel() {
		...
		if(aModel_1714 != null)
		{
			if(AJ.loopCycle >= anInt1708)
				aModel_1714 = null;
			if(AJ.loopCycle >= anInt1707 && AJ.loopCycle < anInt1708)
			{
	...
	public void updatePlayer(Stream stream)
	{
		...
		for(int l = 0; l < 5; l++)
		{
			...
			if(j1 < 0 || j1 >= AJ.anIntArrayArray1003[l].length)
				j1 = 0;
			anIntArray1700[l] = j1;
		}
	...
	public Model method452()
	{
		...
		if(model_1 == null)
		{
			...
			for(int j3 = 0; j3 < 5; j3++)
				...
				{
					model_1.method476(AJ.anIntArrayArray1003[j3][0], AJ.anIntArrayArray1003[j3][anIntArray1700[j3]]);
					if(j3 == 1)
						model_1.method476(AJ.anIntArray1204[0], AJ.anIntArray1204[anIntArray1700[j3]]);
				}
	...
	public Model method453()
	{
		...
		for(int j1 = 0; j1 < 5; j1++)
			...
			{
				model.method476(AJ.anIntArrayArray1003[j1][0], AJ.anIntArrayArray1003[j1][anIntArray1700[j1]]);
				if(j1 == 1)
					model.method476(AJ.anIntArray1204[0], AJ.anIntArray1204[anIntArray1700[j1]]);
			}
